...
weatherApiKey = "487b2cbf7a41a584e2e7a17fd9d96807";
...
async function getCoordinates(city){
    const apiUrl=`http://api.openweathermap.org/geo/1.0/direct?q=${city}&appid=${weatherApiKey}`;
...
async function getWeatherData(city){
    ...
    const responseObj = await getCoordinates(city);
